...
# Das Internet <!-- .slide: data-background-image="imgs/08/internet.svg" --><!-- .element: class="dark shadow" -->
...
![](imgs/08/memex.jpg)<!-- .element: style="height:10em" -->


## Web - (Theoretische) Vorläufer
* Hypertext, Hypermedia, [Project Xanadu](https://en.wikipedia.org/wiki/Project_Xanadu) (1963), von Ted Nelson

[![](imgs/08/xanadu.png)](http://also.kottke.org/misc/images/Screenshot%202014-06-05%2008.56.42.png)
