...
* Folien: <!-- <i class="icon-tugraz_logo" aria-hidden="true"></i> [https://git.iicm.tugraz.at/Info1BM/Folien/](https://git.iicm.tugraz.at/Info1BM/Folien/),--> <nobr><i class="fa fa-gitlab" aria-hidden="true"></i> [https://gitlab.com/flowolf/Info1BM-Folien](https://gitlab.com/flowolf/Info1BM-Folien)</nobr>
