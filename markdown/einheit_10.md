...
# Blockchain<!-- .element: class="light shadow" --><!-- .slide: data-background-image="imgs/10/chains.jpg" -->
...
<!--
## Blockchain Christmas Lights
<!-- . element: class="light shadow" - -> <!-- . slide: data-background-image="imgs/10/lights.gif" - ->
//-->
