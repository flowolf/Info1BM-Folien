...
# Das Internet <!-- .slide: data-background-image="imgs/10/internet.svg" --><!-- .element: class="dark shadow" -->
...
![](imgs/10/memex.jpg)<!-- .element: style="height:10em" -->
...
**** Vorläufer
**** IP, etc
*** Verschiedene Protokolle im Internet
*** Web
*** Topologie des Web
*** Hyper-G
*** OSI-Layer
